        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              key={item.path}
              href={item.path}
              className={`relative py-1 flex items-center gap-1.5 transition-all duration-200 cursor-pointer ${
                isActive
                  ? 'text-[#050505] font-[900] opacity-100'
                  : 'text-[#77776F] font-[700] opacity-70 hover:text-[#050505] hover:opacity-100'
              }`}
            >
              ...
              {/* Sliding brutalist underline indicator */}
